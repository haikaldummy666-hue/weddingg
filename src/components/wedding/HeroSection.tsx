...
export const HeroSection = () => {
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center py-20 px-4 overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-center gap-12 md:gap-24">
        
        {/* Left Column: Text (Desktop) / Top (Mobile) */}
        <div className="text-center md:text-right order-2 md:order-1 flex-1 space-y-6">
           <p className="text-sm font-sans uppercase tracking-[0.4em] text-gold/80 animate-fade-in">
            The Wedding Of
          </p>
          <h1 className="font-script text-6xl md:text-8xl lg:text-9xl text-transparent bg-clip-text bg-gradient-to-r from-gold via-white to-gold animate-shimmer drop-shadow-lg">
        ...
        <div className="order-1 md:order-2 relative group perspective-1000">
           ...
           {/* Floating Container */}
           <div className="relative w-72 h-[28rem] md:w-80 md:h-[32rem] animate-float-slow transform-style-3d transition-transform duration-700 group-hover:rotate-y-6">
              
              {/* Gold Border Frame (Behind) */}
              <div className="absolute -top-4 -right-4 w-full h-full border-2 border-gold/40 rounded-sm z-0" />
              <div className="absolute -bottom-4 -left-4 w-full h-full border-2 border-gold/40 rounded-sm z-0" />
        ...
        <div className="text-center md:text-left order-3 flex-1 space-y-6">
           ...
           <h1 className="font-script text-6xl md:text-8xl lg:text-9xl text-transparent bg-clip-text bg-gradient-to-r from-gold via-white to-gold animate-shimmer drop-shadow-lg" style={{ animationDelay: "1s" }}>
            {weddingConfig.groom.name}
          </h1>
           <p className="font-serif text-xl md:text-2xl tracking-widest text-white/80 border-t border-b border-gold/30 py-2 inline-block">
